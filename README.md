...
("cnpjexiste") - Procura se já existe, verifica se está ativo e se EXISTIR retorna 14 alfanumericos
...
("cpflogin") - verifica se consta na lista de cadastro, verifica se está ativo, verifica se é maior de 18, verificar se tem na lista restritos, retornar cpf (Para TelaOpcoesPassageiro).
